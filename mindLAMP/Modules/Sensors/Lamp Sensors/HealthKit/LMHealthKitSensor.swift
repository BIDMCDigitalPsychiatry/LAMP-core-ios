...
class LMHealthKitSensor: NSObject {
    ...
    private var arrCharacteristicData = [LMHealthKitSensorData]()
    //HKWorkoutData
    ...
    lazy var healthCategoryTypes: [HKSampleType] = {
...
extension LMHealthKitSensor {
    ...
    public func latestCharacteristicData() -> [LMHealthKitSensorData]? {
    ...
    func loadCharachteristicData() {
        ...
        do {
            ...
            */
            if let date = Calendar.current.date(from: birthdayComponents) {
                ...
                data.lampIdentifier = HKCharacteristicTypeIdentifier.dateOfBirth.jsonKey
                arrData.append(data)
            }
        ...
        do {
            ...
            data.lampIdentifier = HKCharacteristicTypeIdentifier.biologicalSex.jsonKey
            arrData.append(data)
        } catch let error {
            LMLogsManager.shared.addLogs(level: .warning, logs: Logs.Messages.hk_characteristicType_fetch_error + error.localizedDescription)
        }
        ...
        do {
            ...
            data.lampIdentifier = HKCharacteristicTypeIdentifier.bloodType.jsonKey
            arrData.append(data)
        } catch let error {
            LMLogsManager.shared.addLogs(level: .warning, logs: Logs.Messages.hk_characteristicType_fetch_error + error.localizedDescription)
        }
        ...
        do {
            ...
            data.lampIdentifier = HKCharacteristicTypeIdentifier.wheelchairUse.jsonKey
            arrData.append(data)
        } catch let error {
            LMLogsManager.shared.addLogs(level: .warning, logs: Logs.Messages.hk_characteristicType_fetch_error + error.localizedDescription)
        }
        do {
            ...
            data.lampIdentifier = HKCharacteristicTypeIdentifier.fitzpatrickSkinType.jsonKey
            arrData.append(data)
        } catch let error {
            LMLogsManager.shared.addLogs(level: .warning, logs: Logs.Messages.hk_characteristicType_fetch_error + error.localizedDescription)
        }
    ...
    private func saveQuantityData(_ samples: [HKQuantitySample], for type: HKSampleType) {
        ...
        for sample in samples {
            ...
            data.lampIdentifier = typeIdentifier.jsonKey
