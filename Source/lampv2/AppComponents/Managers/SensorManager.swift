...
//  lampv2
//
//  Created by Ronny Antony on 14/01/20.
...
class SensorManager {
    ...
    private func startTimer() {
        print(#function)
        sensorApiTimer = Timer.scheduledTimer(timeInterval: 30, target: self, selector: #selector(postSensorData), userInfo: nil, repeats: true)
    }
...
extension SensorManager {
    ...
    private func fetchAccelerometerData() -> SensorData.Request? {
        ...
        return SensorData.Request(timestamp: timeStamp, sensor: SensorType.lamp_accelerometer.stringValue, sensorData: model)
    }
    ...
    private func fetchAccelerometerMotionData() -> SensorData.Request? {
        ...
        return SensorData.Request(timestamp: timeStamp, sensor: SensorType.lamp_accelerometer_motion.stringValue, sensorData: model)
    }
    ...
    private func fetchGyroscopeData() -> SensorData.Request? {
        ...
        let timeStamp = data.timeStamp ?? Date.currentTimeSince1970()
        return SensorData.Request(timestamp: timeStamp, sensor: SensorType.lamp_gyroscope.stringValue, sensorData: model)
    }
    ...
    private func fetchMagnetometerData() -> SensorData.Request? {
        ...
        let timeStamp = data.timeStamp ?? Date.currentTimeSince1970()
        return SensorData.Request(timestamp: timeStamp, sensor: SensorType.lamp_magnetometer.stringValue, sensorData: model)
    }
    ...
    private func fetchHeartRateData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_heart_rate.stringValue, dataModel: model)
    }
    ...
    private func fetchSleepData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_sleep.stringValue, dataModel: model)
    }
    ...
    private func fetchStepsData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_steps.stringValue, dataModel: model)
    }
    ...
    private func fetchFlightsData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_flights.stringValue, dataModel: model)
    }
    ...
    private func fetchDistanceData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_distance.stringValue, dataModel: model)
    }
    ...
    private func fetchGPSContextualData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_gps_contextual.stringValue, dataModel: model)
    }
    ...
    private func fetchGPSData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_gps.stringValue, dataModel: model)
    }
    ...
    private func fetchBluetoothData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_bluetooth.stringValue, dataModel: model)
    }
    ...
    private func fetchWiFiData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_wifi.stringValue, dataModel: model)
    }
    ...
    private func fetchScreenStateData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_screen_state.stringValue, dataModel: model)
    }
    ...
    private func fetchCallsData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_calls.stringValue, dataModel: model)
    }
    ...
    private func fetchWorkoutSegmentData() -> SensorData.Request? {
        ...
        return sensorDataRequest(with: dict, sensor: SensorType.lamp_segment.stringValue, dataModel: model)
    }
}

extension SensorManager {
    
    func sensorDataRequest(with dict: [String: Any], sensor: String, dataModel: SensorDataModel) -> SensorData.Request {
        let timeStamp = dict["timestamp"] as? Double ?? Date.currentTimeSince1970()
        return SensorData.Request(timestamp: timeStamp, sensor: sensor, sensorData: dataModel)
    }
    ...
    func fetchHealthKitQuantityData() -> [SensorData.Request]? {
        ...
        if let dict = latestData(for: HKIdentifiers.weight.rawValue, in: arrData) {
            ...
            arrayRequest.append(sensorDataRequest(with: dict, sensor: SensorType.lamp_weight.stringValue, dataModel: model))
        }
        //get latest Height
        if let dict = latestData(for: HKIdentifiers.height.rawValue, in: arrData) {
            ...
            arrayRequest.append(sensorDataRequest(with: dict, sensor: SensorType.lamp_height.stringValue, dataModel: model))
        }
        ...
        if let dictDiastolic = latestData(for: HKIdentifiers.bloodpressure_diastolic.rawValue, in: arrData), let dictSystolic = latestData(for: HKIdentifiers.bloodpressure_systolic.rawValue, in: arrData) {
            ...
            arrayRequest.append(sensorDataRequest(with: dictDiastolic, sensor: SensorType.lamp_blood_pressure.stringValue, dataModel: model))
        }
        ...
        if let dict = latestData(for: HKIdentifiers.respiratory_rate.rawValue, in: arrData) {
            ...
            arrayRequest.append(sensorDataRequest(with: dict, sensor: SensorType.lamp_respiratory_rate.stringValue, dataModel: model))
        }
        return arrayRequest
    }
